...
main(int argc, char **argv)
{
  ...
  slider = EZ_CreateSlider(frame,"speed", 0.0, 10.0, 1.0,
			   EZ_VERTICAL_SLIDER);
  EZ_AddWidgetCallBack(slider, EZ_CALLBACK, sliderCallBack, &speed, 0);

  /* create a button to toggle double buffer on/off */
  cbtn = EZ_CreateCheckButton(canvas, "Turn DoubleBuffer On/Off", 0, 1, 0, 1);
  EZ_ConfigureWidget(cbtn, EZ_CALLBACK, cbtnCallBack, NULL,
		     EZ_BORDER_WIDTH, 2, EZ_BORDER_TYPE, EZ_BORDER_RAISED,0);
