...
#endif
			      XPutPixel(EZ_RowImage, pixel_index++, 0,
		  ...
		  if(x1 > x)
...
#else
			      SET_PIXEL_VALUE_RGB(pix_value, x, y, r, g, b);
			      /* SET_PIXEL_VALUE_RGB_FIX(pix_value, x, y, r, g, b);*/
#endif
			      XPutPixel(EZ_RowImage, pixel_index++, 0, pix_value);
#ifdef _ZBUFFERED_  
			    }
			  else if(pixel_index)
			    {
		      ...
		      if( *zbufptr > zv)
			{
			  *zbufptr = zv;
			  ...
			  /* SET_PIXEL_VALUE_RGB_FIX(pix_value, x, y, r, g, b); */
#endif
			  XSetForeground(EZ_Display, EZ_MainGC, pix_value);
			  XDrawPoint(EZ_Display,EZ_Drawable, EZ_MainGC,x,y);
#ifdef _ZBUFFERED_  
			}
#endif
...
#ifdef _DITHER_
			      ditherXY = ditherY + (x &0x0F);
			      SET_PIXEL_VALUE_RGB255_FLAT_DITHER(pix_value,ditherXY,dDr,dDg,dDb,
